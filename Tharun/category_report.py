...
thread_df       = pd.read_excel("C:\\Users\\tarun\\Downloads\\Sample Data\\Sample Data\\Threads.xlsx")   # threads data_file
incident_df     = pd.read_excel("C:\\Users\\tarun\\Downloads\\Sample Data\\Sample Data\\Incidents.xlsx") # incident data_file
...
# Predicting on Test split dataset 
predict=model.predict(fitted_vectorizer.transform(X_test))

# saving the classification reports.
report = metrics.classification_report(y_test, predict,output_dict=True)
report_df = pd.DataFrame(report).transpose()
report_df.to_excel('category_report.xlsx')
